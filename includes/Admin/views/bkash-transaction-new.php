<div class="wrap">
    <h1><?php _e( 'New transaction', 'dc-edd-bkash' ); ?></h1>
    ...
    <form action="" method="post">
        <table class="form-table">
            <tbody>
                <tr class="row<?php echo $this->has_error( 'payment_id' ) ? ' form-invalid' : '' ;?>">
                    ...
                    <td>
                        <input type="text" name="payment_id" id="payment_id" class="regular-text" placeholder="<?php echo esc_attr( '', 'dc-edd-bkash' ); ?>" value=""  />
                ...
                <tr class="row<?php echo $this->has_error( 'trx_id' ) ? ' form-invalid' : '' ;?>">
                    ...
                    <td>
                        <input type="text" name="trx_id" id="trx_id" class="regular-text" placeholder="<?php echo esc_attr( '', 'dc-edd-bkash' ); ?>" value=""  />
                ...
                <tr class="row<?php echo $this->has_error( 'transaction_status' ) ? ' form-invalid' : '' ;?>">
                    ...
                    <td>
                        <input type="text" name="transaction_status" id="transaction_status" class="regular-text" placeholder="<?php echo esc_attr( '', 'dc-edd-bkash' ); ?>" value=""  />
                ...
                <tr class="row<?php echo $this->has_error( 'invoice_number' ) ? ' form-invalid' : '' ;?>">
                    ...
                    <td>
                        <input type="text" name="invoice_number" id="invoice_number" class="regular-text" placeholder="<?php echo esc_attr( '', 'dc-edd-bkash' ); ?>" value=""  />
                ...
                <tr class="row<?php echo $this->has_error( 'order_number' ) ? ' form-invalid' : '' ;?>">
                    ...
                    <td>
                        <input type="text" name="order_number" id="order_number" class="regular-text" placeholder="<?php echo esc_attr( '', 'dc-edd-bkash' ); ?>" value=""  />
                ...
                <tr class="row<?php echo $this->has_error( 'amount' ) ? ' form-invalid' : '' ;?>">
                    ...
                    <td>
                        <input type="text" name="amount" id="amount" class="regular-text" placeholder="<?php echo esc_attr( '', 'dc-edd-bkash' ); ?>" value=""  />
                ...
                <tr class="row<?php echo $this->has_error( 'created_at' ) ? ' form-invalid' : '' ;?>">
                    ...
                    <td>
                        <input type="text" name="created_at" id="created_at" class="regular-text" placeholder="<?php echo esc_attr( '', 'dc-edd-bkash' ); ?>" value=""  />
        ...
        <?php submit_button( __( 'Submit', 'dc-edd-bkash' ), 'primary', 'submit_transaction' ); ?>
    </form>
</div>